...
const STAT_CATEGORIES = [
	...
	{ "key": "best_items_collected",   "label": "Most Items"      },
	{ "key": "best_spells_in_deck",    "label": "Most Spells Deck" },
	{ "key": "best_marrow_shards_run", "label": "Most Shards Run" },
]
		...
		if FileAccess.file_exists(path):
			...
			if data is SaveData:
				profile_data.append({
					...
					"best_items_collected":   data.best_items_collected,
					"best_spells_in_deck":    data.best_spells_in_deck,
					"best_marrow_shards_run": data.best_marrow_shards_run,
				})
